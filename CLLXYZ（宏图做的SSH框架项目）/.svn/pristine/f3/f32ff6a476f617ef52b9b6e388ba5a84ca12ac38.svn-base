...
<div class="col-lg-12" style="margin-top: 30px;margin-bottom: 300px;">
    ...
    <form class="form-horizontal" id="form" >
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="password" class="form-control" id="pwd" name="pwd" placeholder="请输入原密码" onblur="checkPasswords();"/>
        ...
        <div class="form-group" style="margin-left: 230px; padding:10px">
            <div>
                ...
                <a  href="javascript:void(0);" class="btn btn-default" style="margin-left: 100px;" onclick="Canceled();">取消</a>
            </div>
        </div>
    </form>
</div>
...
<script src="<%=path%>/public/plugins/base-64/base-64.js"></script>
</body>
</html>
