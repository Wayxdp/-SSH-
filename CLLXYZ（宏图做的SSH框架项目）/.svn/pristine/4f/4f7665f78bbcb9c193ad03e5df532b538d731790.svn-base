...
<div id="tb">
    <a href="javascript:void(0);" class="easyui-linkbutton" onclick="showActivityDetail('activity.',9);">显示活动</a>
...
<div id="win" class="easyui-window" title="显示区" style="width:800px;height:400px"
    ...
    <div class="col-lg-12" style="margin-top: 30px;">
        ...
        <br/>
            <div class="form-group">
                <a href="javascript:;" onclick="closeWin('win')" class="col-sm-offset-1 btn btn-default btn-md">返回</a>
            </div>
