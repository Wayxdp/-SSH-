                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="password" class="form-control" id="input_password" name="pwd"
                                   placeholder="请输入密码">
                            <span id="error_span" style="font-weight: bold;color: red"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <a href="javascript:void(0);" onclick="adminLogin();" class="btn btn-primary">登录</a>
                            <a href="javascript:void(0);" onclick="adminReset();" class="btn btn-info">重置</a>
                        </div>
                    </div>
                </form>
            </div>
...
<script src="<%=path%>/public/js/zhang/admin.js" type="text/javascript"></script>
</body>
</html>
