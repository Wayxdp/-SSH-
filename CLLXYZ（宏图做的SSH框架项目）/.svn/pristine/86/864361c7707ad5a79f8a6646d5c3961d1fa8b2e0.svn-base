    ...
    <div class="container-fluid">
        ...
        <div id="nav" style="margin-left: 30px;">
            <ul class="nav navbar-nav top-bar" id="ul">
                <li id="L1" class="sel" onmouseover="over('L1')" onmouseout="out('L1')"><a href="<%=path%>/index/showHome">首页</a></li>
                <li id="L2" onmouseover="over('L2')" onmouseout="out('L2')"><a href="<%=path%>/buildings/showBuildings">所有楼盘</a></li>
                <li id="L3" onmouseover="over('L3')" onmouseout="out('L3')"><a href="<%=path%>/activity/showActivities">楼盘活动</a></li>
                <li id="L4" onmouseover="over('L4')" onmouseout="out('L4')"><a href="<%=path%>/article/showArticles">文章资讯</a></li>
                <li id="L5" onmouseover="over('L5')" onmouseout="out('L5')"><a href="<%=path%>/agency/showPagerAgencyIndex">房产经销商</a></li>
                <c:choose>
                    ...
                    <c:when test="${!empty sessionScope.employee}">
                        <li class="dropdown" style="margin-left: 300px;">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">${sessionScope.employee.name}<b class="caret"></b></a>
                            <ul class="dropdown-menu">
                    ...
                    <c:when test="${!empty sessionScope.agency}">
                        <li class="dropdown" style="margin-left: 300px;">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">${sessionScope.agency.name}<b class="caret"></b></a>
                            <ul class="dropdown-menu">
                    ...
                    <c:when test="${!empty sessionScope.admin}">
                        <li class="dropdown" style="margin-left: 300px;">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">${sessionScope.admin.name}<b class="caret"></b></a>
                            <ul class="dropdown-menu">
            ...
            <%--<div id="search_bar" >--%>
                <%--<div class="col-xs-3" style="margin-left:50%;margin-top:-40px;">--%>
                    <%--<div class="input-group">--%>
                        <%--<input id="searchInput" type="text" class="form-control" oninput="doSearch();">--%>
                        <%--<span class="input-group-btn">--%>
                            <%--<a href="<%=path%>/buildings/showSearchResults">--%>
