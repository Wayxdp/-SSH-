    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-9" style="margin-top: 10px; background-color:#f1f1ff">
            ...
            <div id="item0" class="col-lg-4 col-md-3 col-xs-12">
                <dl>
                    <div style="margin-top: 15px;">
                        <dt>
                            <a id="logoHref0" href="#"><img id="logoSrc0" src="<%=path%>/public/images/articles/94e9f00.jpg"
            ...
            <div id="item1" class="col-lg-4 col-md-3 col-xs-12">
                <dl>
                    <div style="margin-top: 15px;">
                        <dt>
                            <a id="logoHref1"  href="#"><img id="logoSrc1" src="<%=path%>/public/images/articles/94e9f00.jpg"
                                             class="img-responsive"></a>
                        </dt>
                    </div>
            ...
            <div id="item2" class="col-lg-4 col-md-3 col-xs-12">
                <dl>
                    <div style="margin-top: 15px;">
                        <dt>
                            <a id="logoHref2" href="#"><img id="logoSrc2" src="<%=path%>/public/images/articles/94e9f00.jpg"
                                             class="img-responsive"></a>
                        </dt>
                    </div>
        ...
        <div class="col-lg-9 col-md-9" style="margin-top: 10px; background-color:#f1f1ff">
            ...
            <div id="item3" class="col-lg-4 col-md-3 col-xs-12">
                <dl>
                    <div style="margin-top: 15px;">
                        <dt>
                            <a id="logoHref3" href="#"><img id="logoSrc3" src="<%=path%>/public/images/articles/94e9f00.jpg"
                                             class="img-responsive"></a>
                        </dt>
                    </div>
            ...
            <div id="item4" class="col-lg-4 col-md-3 col-xs-12">
                <dl>
                    <div style="margin-top: 15px;">
                        <dt>
                            <a id="logoHref4" href="#"><img id="logoSrc4" src="<%=path%>/public/images/articles/94e9f00.jpg"
                                             class="img-responsive"></a>
                        </dt>
                    </div>
            ...
            <div id="item5" class="col-lg-4 col-md-3 col-xs-12">
                <dl>
                    <div style="margin-top: 15px;">
                        <dt>
                            <a id="logoHref5" href="#"><img id="logoSrc5" src="<%=path%>/public/images/articles/94e9f00.jpg"
                                             class="img-responsive"></a>
                        </dt>
                    </div>
        ...
        <div class="col-lg-9 col-md-9" style="margin-top: 10px; background-color:#f1f1ff">
            ...
            <div id="item6" class="col-lg-4 col-md-3 col-xs-12">
                <dl>
                    <div style="margin-top: 15px;">
                        <dt>
                            <a id="logoHref6" href="#"><img id="logoSrc6" src="<%=path%>/public/images/articles/94e9f00.jpg"
                                             class="img-responsive"></a>
                        </dt>
                    </div>
            ...
            <div id="item7" class="col-lg-4 col-md-3 col-xs-12">
                <dl>
                    <div style="margin-top: 15px;">
                        <dt>
                            <a id="logoHref7" href="#"><img id="logoSrc7" src="<%=path%>/public/images/articles/94e9f00.jpg"
                                             class="img-responsive"></a>
                        </dt>
                    </div>
            ...
            <div id="item8" class="col-lg-4 col-md-3 col-xs-12">
                <dl>
                    <div style="margin-top: 15px;">
                        <dt>
                            <a id="logoHref8" href="#"><img id="logoSrc8" src="<%=path%>/public/images/articles/94e9f00.jpg"
                                             class="img-responsive"></a>
                        </dt>
                    </div>
        ...
        <div class="col-lg-3" style="">
            <div class="sideFix pinBg">
                ...
                <div class="sideEwm" style="background-color:#f1f1ff;">
                    <dl>
                        <div style="margin-top: 15px;margin-left: 20px;"><span style="font-size: 22px;display: block;">手机or微信扫一扫</span>海南楼盘随身带
                        </div>
                        <dd>
                            <img src="#"></dd>
                    </dl>
        ...
        <div class="col-lg-offset-3">
            <nav aria-label="Page navigation">
                <ul class="pagination">
                    <li><a onclick="getAllArticleData(1);" href="#item0">首页（当前第<span id="articleCurrentPage">1</span>页）</a></li>
                    <li><a onclick="lastArticlePage();" href="#item0">上一页</a></li>
                    <li><a onclick="nextArticlePage();" href="#item0">下一页</a></li>
                    <li><a onclick="finallyArticlePage();" href="#item0">尾页（总共<span id="articleTotalPage">2</span>页）</a></li>
                </ul>
            </nav>
        </div>
