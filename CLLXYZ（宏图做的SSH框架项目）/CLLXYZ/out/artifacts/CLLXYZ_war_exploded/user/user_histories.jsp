...
<table id="list" class="easyui-datagrid"
       data-options="
        ...
        pageSize:20,
        toolbar:'#tb',
        url:'<%=path %>/history/pagerHistoryUser?id=${sessionScope.user.id}',
        method:'get'">
    <thead>
    <tr>
        <th data-options="field:'id',width:80,checkbox:true">编号</th>
        <th data-options="field:'buildings',width:150,align:'center',formatter:formatBuildings">楼盘</th>
...
<!--顶部栏-->
<div id="tb">
    <a href="javascript:void(0)" class="easyui-linkbutton" onclick="verifyDelete()">删除历史纪录</a>
</div>
...
<div id="dlg-buttons">
    ...
    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-remove" onclick="javascript:$('#dlg').dialog('close')">取消</a>
</div>
...
<script src="<%=path %>/public/js/zhang/history.js"></script>
<script>
    $(function () {
        setPagination("list");
    })
