...
<table id="list" class="easyui-datagrid"
    ...
    <tr>
        ...
        <th data-options="field:'content',width:295">留言内容</th>
        <th data-options="field:'leave_time',width:150,formatter:formatDate">留言时间</th>
        <th data-options="field:'reply',width:295,align:'center'">经销商的回复内容</th>
...
<div id="tb">
    ...
    <a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-remove" onclick="showEditWin();">修改</a>
</div>
