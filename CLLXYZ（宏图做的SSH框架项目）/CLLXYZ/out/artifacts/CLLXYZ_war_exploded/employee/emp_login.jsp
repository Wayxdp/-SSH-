                ...
                <form id="loginForm" class="form-horizontal" style="margin-top: 5px;">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <a href="javascript:void(0);" onclick="employeeLogin();" class="btn btn-primary">登录</a>
                            <a href="javascript:void(0);" onclick="employeeReset();" class="btn btn-info">重置</a>
                        </div>
                    </div>
                </form>
            </div>
...
<script src="<%=path%>/public/js/zhang/employee.js" type="text/javascript"></script>
</body>
</html>