...
<div id="top" data-options="region:'north'">
    <div id="logo">
        <img style="height:78px;height:78px;border-radius:20%;"
             src="<%=path %>${sessionScope.agency.logo}" />
    </div>
    <div id="welcome">
        欢迎您：<a href="javascript:void(0);"  style="color:red">${agency.name}</a>,&nbsp;
        <a href="javascript:void(0);" style="color:greenyellow" onclick="verify()";>安全退出</a>
    </div>
</div>
