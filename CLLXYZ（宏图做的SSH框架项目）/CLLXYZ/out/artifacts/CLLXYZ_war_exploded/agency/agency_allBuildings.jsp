    ...
    <div class="col-lg-12">
        ...
        <form class="form-horizontal" id="form">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <textarea name="equipments" id="equipments" cols="30" rows="10"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <%--<input type="text" class="form-control easyui-validatebox"--%>
                           <%--data-options="required:true, novalidate:true"--%>
                           <%--id="intro" name="intro"/>--%>
                    <textarea name="intro" id="intro" cols="30" rows="10" class="form-control easyui-validatebox"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="number" class="form-control easyui-validatebox  easyui-numberbox"
                           min="0.01" max="100000000" precision="2"
                           data-options="required:true, novalidate:true"
