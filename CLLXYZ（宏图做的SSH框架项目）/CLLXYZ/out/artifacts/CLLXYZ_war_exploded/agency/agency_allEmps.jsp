    ...
    <div class="col-lg-12">
        ...
        <form class="form-horizontal" id="form">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <textarea name="des" id="des" cols="30" rows="10" class="form-control easyui-validatebox  easyui-textberbox"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <textarea name="intro" id="intro" cols="30" rows="10" class="form-control easyui-validatebox  easyui-textberbox"
                        data-options="request:true,novalidate:true"
                    ></textarea>
                </div>
            </div>
